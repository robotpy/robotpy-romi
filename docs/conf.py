...
version = ".".join(romi.version.version.split(".")[:2])
# The full version, including alpha/beta/rc tags.
release = romi.version.version
...
htmlhelp_basename = "RobotPyRomidoc"
